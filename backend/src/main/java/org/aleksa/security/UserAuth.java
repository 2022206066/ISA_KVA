...
public class UserAuth implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (String.valueOf(jwt.getClaim("claims").as(Map.class).get("role")).equalsIgnoreCase("USER")
                || String.valueOf(jwt.getClaim("claims").as(Map.class).get("role")).equalsIgnoreCase("ADMIN")) {
            return true;
        }
